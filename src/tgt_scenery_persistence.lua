env.info("Scenery Persistence Loading")
...
csvFilePath = lfs.writedir() .."pg\\" .. "tgtscenery.csv" 
local savefilename = "tgtsceneryper.lua"
local scenerysavefile = lfs.writedir() .."pg\\" .. savefilename
local tgtsave = lfs.writedir() .."pg\\" .. "tgtsceneryTgtList.lua"
...
if file_exists(tgtsave ) then
  savedSceneryTbl = table.load(tgtsave)
