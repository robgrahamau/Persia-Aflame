...
SCHEDULER:New(nil,function() 
  ...
  HypeMan.sendBotMessage("` $SERVERNAME - Server Info:` Mission Cycle will happen in 45 Minutes")
...
SCHEDULER:New(nil,function() 
  ...
  HypeMan.sendBotMessage("` $SERVERNAME - Server Info:` Mission Cycle will happen in 10 Minutes")
...
SCHEDULER:New(nil,function() 
  ...
  HypeMan.sendBotMessage("` $SERVERNAME - Server Info:` Mission Cycle will happen in 4 Minutes")
end,{},(((60*60) *(resethours)) - (60*1)))
SCHEDULER:New(nil,function() 
  MESSAGE:New("MISSION CYLE WILL HAPPEN IN Aprox 3 Minute",10):ToAll()
  HypeMan.sendBotMessage("` $SERVERNAME - Server Info:` Mission Cycle will happen in 3 Minutes")
end,{},(((60*60) *(resethours)) - (60*3)))
SCHEDULER:New(nil,function() 
  MESSAGE:New("MISSION CYLE WILL HAPPEN IN Aprox 2 Minute",10):ToAll()
  HypeMan.sendBotMessage("` $SERVERNAME - Server Info:` Mission Cycle will happen in 2 Minutes")
