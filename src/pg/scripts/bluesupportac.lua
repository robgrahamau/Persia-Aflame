...
Arco11Spawn = SPAWN:New("Arco 11"):InitLimit(1,3):OnSpawnGroup(function(spawngroup) 
  Arco11 = spawngroup
end,{}):InitRepeatOnLanding():InitCleanUp(600):SpawnScheduled(1800,0.5)
...
end,{}):InitRepeatOnLanding():InitLimit(1,2):InitCleanUp(600):SpawnScheduled(1800,0.5)
