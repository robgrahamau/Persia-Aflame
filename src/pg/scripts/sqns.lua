...
cap1 = sqn:New("Eagle CAP","USCAP1",300,math.random(2,16),2,(60*30),AIRBASE.PersianGulf.Al_Dhafra_AB)
cap2 = sqn:New("Mirage CAP","USCAP2",300,math.random(2,16),2,(60*30),AIRBASE.PersianGulf.Al_Dhafra_AB)
...
--shiraz
i30th = sqn:New("30th Squadron CAP 1","IRAF30th",300,math.random(2,12),2,(60*25),AIRBASE.PersianGulf.Shiraz_International_Airport)
i30th_1 = sqn:New("30th Squadron CAP 2","IRAF30th-1",300,math.random(2,12),2,(60*35),AIRBASE.PersianGulf.Shiraz_International_Airport)
...
--kish
i91st = sqn:New("91st Squadron CAP 1","IRAF91",300,math.random(2,12),2,(60*35),AIRBASE.PersianGulf.Kish_International_Airport)
i91st_1 = sqn:New("91st Squadron CAP 2","IRAF91",300,math.random(2,12),2,(60*45),AIRBASE.PersianGulf.Kish_International_Airport)
