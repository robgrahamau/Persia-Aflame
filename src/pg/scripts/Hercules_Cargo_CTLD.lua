...
local Cargo_Container_Enclosed = true
	...
	local Soldier = 
	{
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID .."#1",
			...
			[2] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#2",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [2]
			[3] = 
			{
				...
				["x"] = Cargo_Drop_Position.x + 1.0 + GroupSpacing,
				["name"] = "Soldier Unit "..SoldierGroupID.."#3",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [3]
			[4] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#4",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [4]
			[5] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#5",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [5]
			[6] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#6",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [6]
			[7] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#7",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [7]
			[8] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#8",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [8]
			[9] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#9",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [9]
			[10] = 
			{
				...
				["name"] = "Soldier Unit "..SoldierGroupID.."#10",
				["heading"] = CargoHeading,
				["playerCanDrive"] = false,
			}, -- end of [10]
		}, -- end of ["units"]
		...
		["name"] = "HD Soldier_Group_"..SoldierGroupID,
		["start_time"] = 0,
	}
...
function Hercules_Cargo.Cargo_SpawnGroup(Cargo_Drop_initiator,Cargo_Drop_Position, Cargo_Type_name, CargoHeading, Cargo_Country)
	...
	local Cargo = 
	{
		...
		["y"] = Cargo_Drop_Position.z,
		["x"] = Cargo_Drop_Position.x,
		["name"] = "HD_CARGO Group "..CargoUnitID,
		["start_time"] = 0,
	}
	--added by wrench
	if genericBool then
	...
	if ctld and initiatorCoa == 2 then
		if Cargo_Type_name == "Hummer" or Cargo_Type_name == "SKP-11" then
			local _code = table.remove(ctld.jtacGeneratedLaserCodes, 1)
            --put to the end
            table.insert(ctld.jtacGeneratedLaserCodes, _code)
            ctld.JTACAutoLase(spawnGrp:getName(), _code) --(_jtacGroupName, _laserCode, _smoke, _lock, _colour)
		end
