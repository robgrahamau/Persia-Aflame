...
ABItem = AIRBASE:FindByName("Bandar Abbas Intl")
ABItem:SetAutoCaptureOFF()
ABItem:SetCoalition(1)
ABItem = AIRBASE:FindByName("Havadarya")
ABItem:SetAutoCaptureOFF()
ABItem:SetCoalition(1)
ABItem = AIRBASE:FindByName("Al Minhad AFB")
ABItem:SetAutoCaptureOFF()
ABItem:SetCoalition(2)
ABItem = AIRBASE:FindByName("Al Dhafra AFB")
ABItem:SetAutoCaptureOFF()
ABItem:SetCoalition(2)