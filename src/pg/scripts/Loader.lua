...
hm("> Persia Aflame 2.7 client.lua")
dofile(lfs.writedir() .. [[pg\scripts\client.lua]])
hm("> Persia Falme 2.7: ALL SCRIPTS LOADED, HAVE A GOOD 8 HRS.")
hm("=============================================")